(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 18132))
 (memory $0 1)
 (data (i32.const 1036) "\1c")
 (data (i32.const 1052) "\04\00\00\00\01\02\03\ff")
 (data (i32.const 1068) "<")
 ...
 (data (i32.const 1516) "<")
 (data (i32.const 1528) "\01\00\00\00&\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00b\00u\00f\00f\00e\00r\00.\00t\00s")
 (data (i32.const 1580) ",")
 ...
 (data (i32.const 1724) "B\00\00\00\00\00\00\00\02\t\00\00\00\00\00\00A\08\00\00\02")
 (export "get_buffer" (func $assembly/get_buffer/get_buffer))
    ...
    block $invalid
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $folding-inner1 $folding-inner1 $folding-inner0 $invalid
      end
      return
     end
     return
 ...
 (func $assembly/get_buffer/get_buffer (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
